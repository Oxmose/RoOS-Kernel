 ...
 *
 * @details Allocates a block of memory of the specified size. The contents of
 * the allocated memory are not initialized, and the function returns a pointer
 * to the beginning of the block. If the allocation fails, the function returns
 * NULL.
 *
 ...
 *
 * @details Frees a block of memory that was previously allocated by malloc.
 * The function does not check if the pointer is valid, and it is the caller's
 * responsibility to ensure that the pointer points to a valid memory block.
 *
