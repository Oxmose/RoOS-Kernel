...
multibootHeaderStart:
  ...
  dd -(MAGIC + (multibootHeaderEnd - multibootHeaderStart))
align 8
  ; info request
  dw 1
  dw 0
...
__kInitInitLM:
  ...
  mov  edi, (_START_BSS_ADDR - KERNEL_MEM_OFFSET)
  xor  esi, esi
__bssInit:
  mov  [edi], esi
  add  edi, 4
...
__kInitInitPGdir:
  ...
  mov ebx, (_kernelPDP - KERNEL_MEM_OFFSET)
  mov ecx, (_kernelPD - KERNEL_MEM_OFFSET)
