...
{
    S_KernelQueueNode* nodes[40] = { NULL };
    S_KernelQueueNode* find;
    S_KernelQueue*      queue = NULL;
    uint32_t       old_size;
    uint32_t       sorted[40];
    ...
    /* Create node */
    nodes[0] = KQueueCreateNode((void*) 0, NULL);
    ...
    {
        nodes[i] = KQueueCreateNode((void*) (uintptr_t)unsorted[i % 10], NULL);
